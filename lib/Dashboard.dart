    ...
    return BarChart(
      BarChartData(
        ...
        barGroups: [
          BarChartGroupData(
              x: 0,
              barRods: [BarChartRodData(toY: 400, color: Colors.green[200])]),
          BarChartGroupData(
              x: 1,
              barRods: [BarChartRodData(toY: 300, color: Colors.green[200])]),
          BarChartGroupData(
              x: 2,
              barRods: [BarChartRodData(toY: 500, color: Colors.green[200])]),
          BarChartGroupData(
              x: 3,
              barRods: [BarChartRodData(toY: 200, color: Colors.green[200])]),
          BarChartGroupData(
              x: 4,
              barRods: [BarChartRodData(toY: 300, color: Colors.green[200])]),
        ],
